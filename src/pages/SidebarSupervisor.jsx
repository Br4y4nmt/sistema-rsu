...
const SidebarSupervisor = ({ mostrarSidebar, onClose }) => {
    ...
    <aside className="w-[258px] min-h-screen bg-white shadow-lg flex flex-col items-center py-6 relative transition-all duration-300">
      ...
      <nav className="w-full flex-1">
        ...
        >
            ...
            <span className="text-[16px] font-semibold text-gray-800">Gestión Académica</span>
          ...
          {mostrarSubmenu && (
           ...
           <Link
              ...
              <li>
            <Link
              to="/examen-supervisor"
              className={`flex items-center gap-2 rounded-lg px-3 py-[7px] text-[14px] font-semibold transition-colors ${
                location.pathname === '/examen-supervisor'
                  ? 'bg-[#011B4B] text-white'
                  : 'bg-transparent text-gray-800 hover:bg-gray-100 hover:text-gray-900'
              }`}
            >
              ...
              Examen
               ...
               <li>
                <Link
                    to="/actividad-supervisor"
                    className={`flex items-center gap-2 rounded-lg px-3 py-[7px] text-[14px] font-semibold transition-colors ${
                    location.pathname === '/actividad-supervisor'
                        ? 'bg-[#011B4B] text-white'
                ...
                <li>
                    <Link
                        to="/estudiantes-supervisor"
                        className={`flex items-center gap-2 rounded-lg px-3 py-[7px] text-[14px] font-semibold transition-colors ${
                        location.pathname === '/estudiantes-supervisor'
                            ? 'bg-[#011B4B] text-white'
                            : 'bg-transparent text-gray-800 hover:bg-gray-100 hover:text-gray-800'
                        }`}
                    >
